...
function EditPP() {
  ...
  const onSave = async () => {
    try {
      ...
      const updated = {
        ...(user || {}),
        avatarCharId: data.avatarCharId,
        ...
        <section className="ePP-left">
          ...
          <div className="ePP-preview" style={{ "--glow": activeColor }}>
            <img
              ...
              style={{
                transform: `translate(${active.previewX ?? 0}px, ${
                  active.previewY ?? 0
                }px) scale(${active.previewScale ?? 1})`,
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        backgroundPosition: `${ch.focusX ?? 50}% ${
                          ch.focusY ?? 35
                        }%`,
